...
case 1:
printf("\nSorry for inconvenience, your booking cannot proceeed due to
being COVID POSITIVE\n");
exit(0);
break;
case 2:
printf("\nSorry for inconvenience, your booking cannot proceed and you
cannot board the plane due to HEART DISEASES\n");
exit(0);
break;
case 3:
printf("\nSorry for inconvenience, your booking cannot proceed and you
cannot board the plane due to APPENDIX PAIN\n");
exit(0);
break;
case 4:
printf("\nSorry for inconvenience, your booking cannot proceed and you
cannot board the plane due to having RECENT SURGERIES\n");
exit(0);
break;
defualt:
...
if (from == dst)
{
printf("\nInavlid,Both the pickup and destination are same, please
...
{
printf("\n In Business class 1 to 15 seats are alloted, please

select between 1 to 15 seats.\n");
...
{
printf("\n In Economy class 15 to 30 seats are alloted, please

select between 15 to 30 seats.\n");

goto Seat;
}
default:
printf(" Please select between [1] Business Class [2] Economy
class\n\n");
goto Seat;
break;
}
